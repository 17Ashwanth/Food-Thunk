...
function Footer() {
  return (
    <div>
        ...
        <div className='d-flex justify-content-evenly p-3' style={{backgroundColor:'orangered'}}>
          <div>
            <h3><i style={{color:'white'}} class="fa-solid fa-bowl-food"> <span style={{color:'black'}}>HOT BUCKET.</span> </i></h3>

            Hot Bucket, where culinary excellence meets the digital world! <br /> Our restaurant website is designed to be your virtual gateway <br /> to a gastronomic adventure.
